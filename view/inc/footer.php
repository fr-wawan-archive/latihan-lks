<footer>
    <div class="footer-content">
        <div class="footer-text">
            ...
            <p>
                ...
                perspiciatis obcaecati quisquam laboriosam fugiat saepe consectetur,
                et nemo doloribus reprehenderit atque repellat perferendis.
                Consequatur non fuga minima distinctio. Obcaecati, dignissimos.
            </p>
        </div>
        <div class="footer-content">
            <div>
    ...
    <hr />
    <div class="svg-flex">
        <p>© MyStore, Inc. 2019. We love our users!</p>
        <div>
